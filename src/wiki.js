    ...
    // ------------------------------------------------------------------ 8
    {
      ...
      blocks: [
        ...
        { t: "terms", items: [
          ...
          { term: "Service", def: "Un service de cette entité : « Direction générale des services », « Action sociale »… C'est à un service qu'un dossier est rattaché." },
        ...
        { t: "steps", items: [
          ...
          { text: "Cliquez un nœud pour ouvrir sa **fiche** : forme, code, nom, dénomination légale, personnalité morale, rattachement, et — pour une entité — son **signataire principal**." },
          { text: "Dans la fiche d'un service, ajoutez ou retirez ses **bureaux** sans quitter l'écran." },
        ] },
        { t: "note", kind: "info", title: "Tout le monde peut le consulter", text: "Savoir qui existe et qui signe n'est pas un secret : l'organigramme est ouvert à tous les comptes. Le modifier demande les droits d'administration habituels." },
...
"Après la signature : **publication** et **formalités** (transmission, notification)",
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "terms", items: [
          { term: "Clé d'API", def: "Le mot de passe d'un logiciel. Elle se crée dans Administration › Autorisation, et porte un rôle : elle ne peut pas faire plus que son rôle." },
