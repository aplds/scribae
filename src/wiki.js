...
export const GUIDE = {
  ...
  pathways: [
    ...
    { label: "Je m'en sers déjà", hint: "Les raccourcis utiles", chapters: ["rediger", "export", "retrouver", "corbeille", "modifier", "annexes", "depannage"] },
    { label: "Je valide des actes", hint: "Le parapheur, la révision, et ce qui suit", chapters: ["parapheur", "revision", "signature", "signature-externe", "execution", "mots"] },
    { label: "Je publie un acte", hint: "Signature (électronique ou papier), ELI, opposabilité, délais", chapters: ["parapheur", "signature", "signature-externe", "publication", "execution", "modifier", "annexes", "abrogations"] },
    { label: "Je prépare les modèles", hint: "Pour les administrateurs", chapters: ["administrateurs", "chartes", "annexes", "modifier", "mots", "depannage"] },
  ...
  chapters: [
    ...
    // ------------------------------------------------ 5 ter : publication (ELI)
    {
      ...
      blocks: [
        ...
        { t: "note", kind: "info", title: "Les mentions du bas de page", text: "Un site public se termine par ses **mentions**, et le recueil public les porte en bas de page. Les **mentions légales** rappellent à quelles conditions un acte est **exécutoire et opposable** : la publication et la transmission au représentant de l'État (article L. 2131-1 du code général des collectivités territoriales), puis le **délai de recours de deux mois** à compter de la publication (article R. 421-1 du code de justice administrative). Les **mentions d'accessibilité** rappellent les obligations d'accessibilité d'un service de communication publique en ligne (article 47 de la loi du 11 février 2005, référentiel RGAA), l'existence de la **déclaration d'accessibilité** et du schéma pluriannuel, et la façon de **signaler un obstacle** — jusqu'à saisir le Défenseur des droits. Ces deux textes sont **livrés prêts à l'emploi**, et se règlent dans **Administration › Publication › Mentions du recueil public**. Pour chacune, vous avez **trois choix** : le **texte** s'affiche dans la page, replié sous son titre (le lecteur le déplie d'un clic) ; un **lien** le remplace par un simple renvoi — c'est ce qu'on fait quand la collectivité tient déjà ses mentions légales sur le site principal de la mairie ; ou **rien du tout**, si votre situation demande de ne pas les afficher. Le bouton **Rétablir le texte livré** ramène la mention livrée avec l'application, qu'on n'écrase donc jamais vraiment." },
    ...
    // ------------------------------------------------------------------ 7
    {
      ...
      blocks: [
        ...
        { t: "note", kind: "info", title: "Rien de figé dans le code", text: "Entités, personnes, rôles, références, mentions, vocabulaire de rédaction, numérotation, **circuits de validation** (Administration › Circuits de validation), **délais** (Administration › Exécution & délais) et **recueil** (Administration › Publication : titre du recueil, publication automatique après signature, règle d'opposabilité, les **recueils extérieurs et renvois** du bas de page public, et les **mentions légales et d'accessibilité** de ce même bas de page) : tout se règle dans **Administration**. On y change une formule de recours, un type d'acte, ou l'ordre des visas à obtenir sans toucher à l'application." },
...
"Après la signature : **publication** et **formalités** (transmission, notification)",
    ...
    // ------------------------------------------------------------------ 15
    {
      ...
      short: "Pour les administrateurs : les trois façons de se connecter — comptes de l'application, comptes locaux à mot de passe (réglés dans le `.env` du service), ou annuaire d'entreprise (OpenID Connect).",
      icon: "lock",
      minutes: 6,
      audience: "admin",
      keywords: "annuaire sso oidc openid connect authentification connexion groupes rôle désactiver comptes démonstration fournisseur identité pkce jeton annuaire d'essai clé signature mot de passe local compte local .env déploiement auto-hébergé identifiant scrypt session cookie csrf administrateur admin",
      blocks: [
