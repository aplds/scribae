...
export const GUIDE = {
  ...
  pathways: [
    ...
    { label: "Je publie un acte", hint: "Signature (électronique ou papier), ELI, opposabilité, délais", chapters: ["parapheur", "signature", "signature-externe", "publication", "informations", "reprises", "execution", "modifier", "annexes", "abrogations"] },
  ...
  chapters: [
    ...
    // ------------------------ 5 bis (ter) : la signature simple (dans l'appli)
    {
      ...
      blocks: [
        ...
        { t: "note", kind: "info", title: "Envoyer n'est pas signer", text: "Deux gestes distincts, souvent confondus. **Envoyer en signature** — déposer l'acte et ouvrir le circuit — appartient à la **rédaction** : un rédacteur, un éditeur, un réviseur ou un administrateur le fait, et c'est par ce geste que le **réviseur**, en validant un acte, le fait partir. **Signer**, en revanche, n'appartient qu'au **titulaire** de la signature — le dernier étage de la chaîne de l'acte, celui que l'acte désigne — et à condition qu'il porte la **qualité de Signataire**. La fenêtre de signature ne s'ouvre donc que pour lui : si un autre compte envoie l'acte, l'application le prévient que l'acte est parti et attend la signature de son titulaire, sans lui proposer de signer à sa place." },
    ...
    // src/lib/informations.js.
    {
      ...
      blocks: [
        ...
        { t: "next", chapter: "reprises", label: "Reprendre un acte ancien (avant l'informatique)" },
      ],
    },
    // -------------------- 5 ter ter : la reprise d'actes anciens
    // Ce chapitre a son écran (`src/ui/views/reprises.js`), sa collection
    // (`reprises`) et ses règles pures (`src/lib/reprise.js`) : une reprise ne
    // suit ni le parapheur, ni la signature, ni la numérotation courante.
    {
      id: "reprises",
      title: "Reprendre un acte ancien (avant l'informatique)",
      short: "Faire entrer au recueil les actes signés avant Scribae : le texte, la date d'origine, l'original scanné — publiés d'un seul geste, à titre informatif.",
      icon: "archive",
      minutes: 4,
      audience: "all",
      keywords: "reprise reprises reprendre ancien anciens ancienne archive archives histoire historique rétroactif numériser numérisation scan scanner original joint pièce jointe date d'origine date de publication d'origine antérieure informatif à titre informatif annexe autonome règlement intérieur charte délibération arrêté 1998 avant mise en service import importer rédacteur publier recueil",
      blocks: [
        { t: "p", text: "Une collectivité qui installe Scribae ne part pas d'un recueil vide : elle a derrière elle des décennies d'actes — délibérations, arrêtés, règlements — signés sur papier et publiés à l'affichage ou dans un bulletin qu'on ne trouve plus. L'écran **Reprises d'actes anciens** les fait entrer au recueil public, pour qu'ils s'y cherchent et s'y lisent comme les actes récents." },
        { t: "p", text: "Une reprise ne prétend pas être un acte d'aujourd'hui. Elle ne suit **aucun circuit** : ni parapheur, ni révision, ni signature. L'acte a déjà été signé, il y a longtemps — la reprise **conserve la preuve** de ce qui a été signé, elle ne le signe pas une seconde fois. C'est le **rédacteur** qui l'écrit, et il écrit ce qu'il veut : un acte de 1998 n'a pas été composé dans une trame qui n'existait pas." },
        { t: "terms", items: [
          { term: "Reprise", def: "Un acte antérieur à la mise en service du recueil, écrit à la main dans l'application, daté de sa **publication d'origine** et publié au recueil public avec l'original signé conservé." },
          { term: "Date de publication d'origine", def: "La date à laquelle l'acte a été publié **à l'époque** — et non le jour où vous faites la reprise. L'application la règle à la main, et refuse une date qui ne serait pas **antérieure à aujourd'hui**." },
          { term: "Original signé joint", def: "Le PDF, ou le scan, de la pièce telle qu'elle a été signée. Vous le déposez à la main : c'est lui qui **fait foi** ; le texte en ligne n'en est qu'une lecture pratique." },
          { term: "Publication informative", def: "Le régime d'une reprise : elle est **publiée**, elle se lit au recueil, mais elle ne rend rien opposable et n'ouvre **aucun délai de recours**. La page publiée le dit elle-même, en bas de page." },
          { term: "Texte autonome (annexe)", def: "Un texte ancien qui se consulte **pour lui-même** — un règlement intérieur, une charte. Il se reprend comme le reste, mais reçoit l'identifiant ELI d'un **règlement** (`eli:/fr/reg/…`), et non celui d'une délibération." },
        ] },
        { t: "steps", items: [
          { text: "Ouvrez **Reprises d'actes anciens** dans le menu, puis cliquez sur **Reprendre un acte ancien**." },
          { text: "Donnez l'**intitulé**, le **genre** (un acte, ou un texte autonome) puis, pour un acte, sa **nature**." },
          { text: "Saisissez le **numéro d'origine** — « 1998-042 », « 1998/12 » : tel qu'il se lit sur l'acte.", detail: "C'est ce numéro qui bâtit l'identifiant ELI au recueil, et son **année** qui date l'acte — l'ELI portera 1998, pas l'année du jour." },
          { text: "Réglez la **date de publication d'origine**.", detail: "Elle ne peut pas être postérieure à la veille du jour ; l'application vous en avertit." },
          { text: "Écrivez le **texte**, librement", detail: "Trois repères suffisent à lui donner sa structure : une ligne blanche sépare les paragraphes, une ligne « Article 3 » (ou « Article 3 — Objet ») ouvre un article, « # », « ## » ou « ### » ouvrent un titre, un chapitre, une section, et « - » fait une liste. Le reste est un paragraphe." },
          { text: "Joignez l'**original signé** (PDF, ou image scannée).", detail: "L'application en calcule l'empreinte SHA-256 et le dépose ; elle affiche la pièce jointe, et permet de la retirer ou de la remplacer." },
          { text: "Vérifiez l'**aperçu** : la version en ligne telle que le recueil la montrera, la mention portée au bas de la page, et ce qui bloque encore la publication s'il manque quelque chose." },
          { text: "Cliquez sur **Publier au recueil**.", detail: "La reprise est publiée **immédiatement**, d'un seul geste, sous son identifiant ELI. Elle apparaît aussitôt au recueil public." },
        ] },
        { t: "note", kind: "info", title: "Qui peut reprendre un acte", text: "Le geste demande la permission **« Reprendre un acte ancien »** — celle des **rédacteurs**, comme la rédaction d'un acte (administrateur, éditeur, réviseur, rédacteur). Un **rédacteur** ne voit que **ses** reprises ; l'administration les voit toutes. Les reprises vivent dans leur **propre registre** : elles ne se mêlent ni aux listes d'actes, ni au chrono, ni à la recherche des actes en cours — elles ne suivent ni le parapheur, ni la numérotation courante." },
        { t: "note", kind: "warn", title: "La date est nécessairement antérieure", text: "On ne republie pas un acte de 1998 à la date d'aujourd'hui : le recueil **mentirait sur sa chronologie**, et ferait croire que les délais de recours courent à compter du jour. La date de publication d'origine doit donc être **antérieure au jour** où vous enregistrez la reprise — l'application refuse le geste sinon, et l'aperçu dit ce qui manque." },
        { t: "note", kind: "info", title: "Ce que le lecteur voit", text: "La page publiée porte, **en bas de page**, la mention qui explique la situation : l'acte est publié **à titre informatif uniquement**, parce qu'il s'agit de la reprise d'un acte antérieur à la mise en service du recueil ; la version en ligne n'a **pas de valeur juridique propre** et **n'ouvre aucun délai de recours** ; seul l'**original signé**, conservé par la collectivité et joint à la page, fait foi. Au-dessus du texte, la notice de l'acte le dit aussi d'une pastille (**Reprise d'un acte ancien**, **texte informatif**, **reprise publiée**), donne la **date de publication d'origine**, la **provenance** que vous avez saisie (« Registre des délibérations, 1998 ») et qui a fait la reprise. Dans la liste du recueil, la mention **« reprise »** signale l'acte : sa date est ancienne, et il ne faut pas le prendre pour un acte du jour." },
        { t: "note", kind: "info", title: "Un texte autonome se reprend aussi", text: "Un **règlement intérieur**, une **charte**, un texte ancien qu'on veut pouvoir consulter pour lui-même se reprend comme un acte : choisissez le genre **Texte autonome (annexe)**. Le recueil le publie alors sous l'identifiant d'un **règlement** (`eli:/fr/reg/1996/0001/vsl`), et il s'y consulte à part. C'est ce qui distingue une reprise d'une **annexe ordinaire** : celle-ci est adoptée par un acte vivant dans l'application, tandis qu'un texte ancien repris n'a, ici, aucun acte d'adoption — d'où sa place au recueil, à titre informatif." },
        { t: "note", kind: "info", title: "Où la reprise se range, et ce qu'elle n'est pas", text: "Une reprise occupe le **même recueil public** que les actes publiés : elle s'y cherche, s'y classe par thème, et son identifiant ELI s'ouvre directement (une **adresse datée de l'année du numéro d'origine**). Mais elle reste une reprise : elle ne se **modifie** pas par un acte modificatif, ne s'**abroge** pas, ne se signe pas et ne se transmet pas au contrôle de légalité. Pour un acte **en cours** — celui que vous prenez aujourd'hui —, le chemin est celui de tous les actes : **Rédiger un acte**, signature, puis publication. La reprise ne sert qu'à ce qui est **antérieur** à la mise en service du recueil." },
        { t: "faq", items: [
          { q: "Faut-il reprendre tous les actes anciens ?", a: "Non. On reprend ce qui mérite d'être **retrouvé** : le règlement intérieur, la délibération qu'on cite encore, le texte que le public demande. L'écran se remplit au fil des besoins, et chaque reprise se publie en quelques minutes." },
          { q: "Puis-je corriger une reprise publiée ?", a: "Une reprise publiée **ne se modifie pas** dans l'application : la version en ligne a été publiée telle quelle, avec l'original qu'elle annonce. Si une coquille vous échappe, retirez la publication (réservé à l'administration) et reprenez l'acte. Un **brouillon**, lui, se corrige tant qu'on veut — rien n'a été publié." },
          { q: "Le texte en ligne a-t-il une valeur juridique ?", a: "Non, et la page le dit. Seul l'**original signé** conservé par la collectivité fait foi. Le texte en ligne est là pour qu'on **trouve** l'acte et qu'on le **lise** commodément — pas pour fonder un droit devant un juge." },
        ] },
